...
const ConfirmationScreen = () => {
  ...
  const fetchAddresses = async () => {
    try {
      const response = await axios.get(`http://192.168.1.8:8000/addresses/${userId}`);
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      const response = await axios.post('http://192.168.1.8:8000/orders', orderData);
            ...
            {addresses?.map((item, index) => (
              ...
              >
                ...
                <View style={{ marginLeft: 6 }}>
                  ...
                  <Text style={{ fontSize: 15, color: '#181818' }}>Binh Dinh, Viet Nam</Text>
      ...
      {currentStep == 1 && (
        <View style={{ marginHorizontal: 20 }}>
          ...
          >
            ...
            <Text style={{ flex: 1 }}>
              <Text style={{ color: 'green', fontWeight: '500' }}>Tomorrow by 10pm</Text> - FREE
        ...
        <View style={{ marginHorizontal: 20 }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ color: 'gray', fontSize: 16 }}>USDVND{total}</Text>
            </View>
            ...
            >
              ...
              <Text style={{ color: 'gray', fontSize: 16 }}>USD0</Text>
            </View>
            ...
            >
              ...
              <Text style={{ color: '#C60C30', fontSize: 17, fontWeight: 'bold' }}>USD{total}</Text>
            </View>
          </View>
